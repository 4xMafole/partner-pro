...
class BuyerChatWidget extends StatefulWidget {
  const BuyerChatWidget({super.key});

  static String routeName = 'buyer_chat';
  static String routePath = '/buyer_chat';

  @override
  State<BuyerChatWidget> createState() => _BuyerChatWidgetState();
}

class _BuyerChatWidgetState extends State<BuyerChatWidget> {
  late BuyerChatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuyerChatModel());
