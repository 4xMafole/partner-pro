...
class _ProfilePageWidgetState extends State<ProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.notificationSwitchValue = FFAppState().enableNotification;
  }
                    ...
                    child: Column(
                      ...
                      children: [
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) =>
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final textGetPropertiesByZipIdResponse =
                                              snapshot.data!;
                                  ...
                                  Switch.adaptive(
                                    ...
                                    onChanged: (newValue) async {
                                      ...
                                      if (newValue) {
                                        ...
                                        FFAppState().enableNotification = false;
                                        safeSetState(() {});
                                      }
                                    },
                        ...
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(RecentlyViewPageWidget.routeName);
                          },
                          child: AnimatedContainer(
                            duration: Duration(milliseconds: 150),
                            curve: Curves.easeInOut,
                                  ...
                                  child: Padding(
                                    ...
                                    child: SupportSheetWidget(
                                      onSubmit: (message) async {
                                        ...
                                        await _model.supportCreated!.reference
                                            .update(createSupportRecordData(
                                          id: _model
                                              .supportCreated?.reference.id,
                                        ));
                                        await showModalBottomSheet(
                                          isScrollControlled: true,
                                          backgroundColor: Colors.transparent,
