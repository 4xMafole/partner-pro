...
import 'favorite_notes_model.dart';
export 'favorite_notes_model.dart';

class FavoriteNotesWidget extends StatefulWidget {
  const FavoriteNotesWidget({
    super.key,
    required this.onSubmit,
  });

  final Future Function(String note)? onSubmit;
...
class _FavoriteNotesWidgetState extends State<FavoriteNotesWidget> {
  late FavoriteNotesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FavoriteNotesModel());
