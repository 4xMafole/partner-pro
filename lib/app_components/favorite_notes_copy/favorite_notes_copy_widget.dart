...
class FavoriteNotesCopyWidget extends StatefulWidget {
  const FavoriteNotesCopyWidget({
    super.key,
  ...
  @override
  State<FavoriteNotesCopyWidget> createState() =>
      _FavoriteNotesCopyWidgetState();
}

class _FavoriteNotesCopyWidgetState extends State<FavoriteNotesCopyWidget> {
  late FavoriteNotesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FavoriteNotesCopyModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.test = await IwoUsersFavoritesApiGroup
