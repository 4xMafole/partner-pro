...
class SearchListWidget extends StatefulWidget {
  ...
  static String routePath = '/searchList';
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final memberResults = _model.searchResults.toList();
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, memberResultsIndex) {
                          final memberResultsItem =
                              memberResults[memberResultsIndex];
                          return wrapWithModel(
                            model: _model.contactItemModels.getModel(
                              memberResultsItem.clientID,
                              memberResultsIndex,
                            ),
                            updateCallback: () => safeSetState(() {}),
                            child: ContactItemWidget(
                              key: Key(
                                'Keyt8y_${memberResultsItem.clientID}',
                              ),
                              hasCheck: false,
                              member: memberResultsItem,
                              onSelected: (value) async {
                                context.pushNamed(
                                  MemberActivityWidget.routeName,
                                  queryParameters: {
