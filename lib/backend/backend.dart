...
import 'schema/offer_payments_record.dart';
import 'schema/suggestions_record.dart';
import 'schema/users_record.dart';
import 'schema/showami_record.dart';
...
export 'schema/offer_payments_record.dart';
export 'schema/suggestions_record.dart';
export 'schema/users_record.dart';
export 'schema/showami_record.dart';
...
/// Functions to query OfferPaymentsRecords (as a Stream and as a Future).
Future<int> queryOfferPaymentsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      OfferPaymentsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<OfferPaymentsRecord>> queryOfferPaymentsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      OfferPaymentsRecord.collection,
      OfferPaymentsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<OfferPaymentsRecord>> queryOfferPaymentsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> querySuggestionsRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      SuggestionsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query ShowamiRecords (as a Stream and as a Future).
Future<int> queryShowamiRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ShowamiRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ShowamiRecord>> queryShowamiRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      ShowamiRecord.collection(parent),
      ShowamiRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ShowamiRecord>> queryShowamiRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
