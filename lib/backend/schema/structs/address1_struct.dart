...
class Address1Struct extends FFFirebaseStruct {
  Address1Struct({
    String? streetName,
    String? streetNumber,
  ...
  static Address1Struct fromMap(Map<String, dynamic> data) => Address1Struct(
  ...
  static Address1Struct? maybeFromMap(dynamic data) =>
      data is Map ? Address1Struct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static Address1Struct fromSerializableMap(Map<String, dynamic> data) =>
      Address1Struct(
  ...
  @override
  String toString() => 'Address1Struct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is Address1Struct &&
...
Address1Struct createAddress1Struct({
  String? streetName,
  String? streetNumber,
  String? streetDirection,
  String? streetType,
...
Address1Struct? updateAddress1Struct(
  Address1Struct? address1, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    address1
...
void addAddress1StructData(
  ...
  if (address1.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && address1.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final address1Data = getAddress1FirestoreData(address1, forFieldValue);
  final nestedData = address1Data.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = address1.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getAddress1FirestoreData(
  Address1Struct? address1, [
  bool forFieldValue = false,
]) {
  if (address1 == null) {
  ...
  final firestoreData = mapToFirestore(address1.toMap());

  // Add any Firestore field values
  address1.firestoreUtilData.fieldValues
      .forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getAddress1ListFirestoreData(
  List<Address1Struct>? address1s,
) =>
    address1s?.map((e) => getAddress1FirestoreData(e, true)).toList() ?? [];
