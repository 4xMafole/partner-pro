...
class MyAddressStruct extends FFFirebaseStruct {
  MyAddressStruct({
    String? streetName,
    String? streetNumber,
  ...
  static MyAddressStruct fromMap(Map<String, dynamic> data) => MyAddressStruct(
  ...
  static MyAddressStruct? maybeFromMap(dynamic data) => data is Map
      ? MyAddressStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MyAddressStruct fromSerializableMap(Map<String, dynamic> data) =>
      MyAddressStruct(
  ...
  @override
  String toString() => 'MyAddressStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is MyAddressStruct &&
...
MyAddressStruct createMyAddressStruct({
  String? streetName,
  String? streetNumber,
  String? streetDirection,
  String? streetType,
...
MyAddressStruct? updateMyAddressStruct(
  MyAddressStruct? myAddress, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    myAddress
...
void addMyAddressStructData(
  ...
  if (myAddress.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && myAddress.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final myAddressData = getMyAddressFirestoreData(myAddress, forFieldValue);
  final nestedData = myAddressData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = myAddress.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getMyAddressFirestoreData(
  MyAddressStruct? myAddress, [
  bool forFieldValue = false,
]) {
  if (myAddress == null) {
  ...
  final firestoreData = mapToFirestore(myAddress.toMap());

  // Add any Firestore field values
  myAddress.firestoreUtilData.fieldValues
      .forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getMyAddressListFirestoreData(
  List<MyAddressStruct>? myAddresss,
) =>
    myAddresss?.map((e) => getMyAddressFirestoreData(e, true)).toList() ?? [];
