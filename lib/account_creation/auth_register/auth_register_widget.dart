import '/account_creation/auth_register_role_dialog/auth_register_role_dialog_widget.dart';
...
class AuthRegisterWidget extends StatefulWidget {
  ...
  static String routeName = 'auth_register';
...
class _AuthRegisterWidgetState extends State<AuthRegisterWidget> {
  ...
  void initState() {
    ...
    _model.agencyTextController ??= TextEditingController();
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (_model.userRole == UserType.Agent)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 16.0),
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode: _model.agencyFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.next,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                      ...
                                      if (_model.userRole == UserType.Agent) {
                                        return Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: !_model.tosCheckboxValue!
                                                ? null
                                                : () async {
                                                    if (_model.formKey
                                                                .currentState ==
                                                    ...
                                                    await UsersRecord.collection
                                                        ...
                                                        .update(
                                                          ...
                                                          hasAcceptedSMS: _model
                                                              .consentCheckboxValue,
                                                        ));

                                                    await _model
                                                        .apiRegister(context);
                                                    _model.pendingInviteDoc =
                                                    ...
                                                    if (_model
                                                      ...
                                                      await RelationshipsRecord
                                                          .collection
                                                          .doc()
                                                          .set(
                                                              createRelationshipsRecordData(
                                                            relationship:
                                                                updateRelationshipTypeStruct(
                                                              _model
                                                                  .newRelationship,
                                                              clearUnsetFields:
                                                                  false,
                                                ...
                                                : () async {
                                                    ...
                                                    if (_model
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        SnackBar(
                                                          content: Text(
                                                            'This app is by invitation only for buyers. Please ask a real estate agent using PartnerPro to send you an invitation.',
                                                            style: TextStyle(
